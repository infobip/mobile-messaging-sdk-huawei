...
public abstract class MobileMessaging {
     ...
     * <br>
     * This method has to be used only if you handle HMS message notifications
     * without Mobile Messaging library. In all other cases the library will
     * send delivery report automatically whenever HMS push is delivered to device.
     *
    ...
    public static final class Builder {
        ...
        private void loadSenderId(Context context) {
            int ibResource = ResourceLoader.loadResourceByName(context, "string", "app_id");
            if (ibResource > 0) {
        ...
        /**
         * When you want to use a HMS sender that is not stored to <i>app_id</i> string resource or to google-services.json file.
         * <br>By default it will use <i>app_id</i> string resource
         *
         * @param senderId if you don't have one, you should <a href="https://developer.huawei.com/consumer/en/doc/development/HMSCore-Guides/android-config-agc-0000001050170137">get one</a>
         * @return {@link Builder}
         */

...
public class PredefinedActionsProvider {
    ...
    public void verifyResourcesForCategory(String categoryId) {
        ...
        try {
            ...
            MobileMessagingLogger.w(TAG, "Resources for [" + categoryId + "] notification category are not found in your project, make sure to include 'infobip-mobile-messaging-huawei-resources' dependency");

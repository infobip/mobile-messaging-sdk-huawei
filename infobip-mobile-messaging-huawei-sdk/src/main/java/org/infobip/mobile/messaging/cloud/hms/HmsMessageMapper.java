 ...
 * @since 03/09/2018.
 */
public class HmsMessageMapper {

    private static final String TAG = HmsMessageMapper.class.getSimpleName();
    ...
    private static IBData getIBData(RemoteMessage remoteMessage) {
        ...
        HMSData hmsData = serializer.deserialize(remoteMessage.getData(), HMSData.class);

        if (hmsData == null || hmsData.org_ib_d == null) {
            return null;
        }

        return hmsData.org_ib_d;
    }

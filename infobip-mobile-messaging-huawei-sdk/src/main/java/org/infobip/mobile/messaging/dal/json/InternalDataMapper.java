...
public class InternalDataMapper {
    ...
    /**
     * @param <VibrateValueType> vibrate comes as String from HMS and as Boolean from Infobip Services
     */
     ...
     * <br> Note that boolean fields will be saved as String for HMS.
     *

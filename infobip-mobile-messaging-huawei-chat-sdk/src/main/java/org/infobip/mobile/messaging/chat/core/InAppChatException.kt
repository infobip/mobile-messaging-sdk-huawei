...
open class InAppChatException @JvmOverloads constructor(
    ...
    class MissingPushRegistrationId : InAppChatException(
        ...
        technicalMessage = """
           InAppChat mandatory parameter push registration ID is missing. Please follow documentation quick-start guide(https://github.com/infobip/mobile-messaging-sdk-huawei#quick-start-guide)
    ...
    class MissingLivechatWidgetId : InAppChatException(
        ...
        technicalMessage = """
           ...
           .com/infobip/mobile-messaging-sdk-huawei/wiki/In%E2%80%90app-chat#quick-start-guide) for correct setup - Livechat Widget connection to Mobile Messaging App profile. Make sure InAppChat
    ...
    class LivechatWidgetNotFound : InAppChatException(
        ...
        platform = PLATFORM_ANDROID,
        technicalMessage = """
           The specified Livechat Widget ID does not exist or is not accessible. Please follow documentation quick-start guide(https://github.com/infobip/mobile-messaging-sdk-huawei/wiki/In%E2%80%90app-chat#quick-start-guide) for correct setup - Livechat Widget connection to Mobile Messaging App profile.
        """.trimIndent()
    )
    ...
    class LivechatWidgetWebViewNotInitialized : InAppChatException(
        ...
        platform = PLATFORM_ANDROID,
        technicalMessage = """
                Livechat Widget WebView not initialized. Please raise an issue in GitHub(https://github.com/infobip/mobile-messaging-sdk-huawei/issues) and provide details how you use InAppChat.
            """.trimIndent()
    )

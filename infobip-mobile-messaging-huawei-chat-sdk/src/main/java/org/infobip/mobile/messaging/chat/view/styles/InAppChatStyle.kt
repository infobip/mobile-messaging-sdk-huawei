...
data class InAppChatStyle @JvmOverloads constructor(
    ...
    class Builder {
        ...
        fun setChatFullScreenErrorTitleText(chatFullScreenErrorTitleText: String?) = apply { chatFullScreenErrorTitleText?.let { this.chatFullScreenErrorTitleText = it } }
        fun setChatFullScreenErrorTitleTextRes(@StringRes chatFullScreenErrorTitleTextRes: Int?) = apply { chatFullScreenErrorTitleTextRes?.let { this.chatFullScreenErrorTitleTextRes = it } }
        fun setChatFullScreenErrorTitleTextColor(@ColorInt chatFullScreenErrorTitleTextColor: Int?) = apply { chatFullScreenErrorTitleTextColor?.let { this.chatFullScreenErrorTitleTextColor = it } }
        fun setChatFullScreenErrorTitleTextAppearance(@StyleRes chatFullScreenErrorTitleTextAppearance: Int?) = apply { chatFullScreenErrorTitleTextAppearance?.let { this.chatFullScreenErrorTitleTextAppearance = it } }
        fun setChatFullScreenErrorDescriptionText(chatFullScreenErrorDescriptionText: String?) = apply { chatFullScreenErrorDescriptionText?.let { this.chatFullScreenErrorDescriptionText = it } }
        fun setChatFullScreenErrorDescriptionTextRes(@StringRes chatFullScreenErrorDescriptionTextRes: Int?) = apply { chatFullScreenErrorDescriptionTextRes?.let { this.chatFullScreenErrorDescriptionTextRes = it } }
        fun setChatFullScreenErrorDescriptionTextColor(@ColorInt chatFullScreenErrorDescriptionTextColor: Int?) = apply { chatFullScreenErrorDescriptionTextColor?.let { this.chatFullScreenErrorDescriptionTextColor = it } }
        fun setChatFullScreenErrorDescriptionTextAppearance(@StyleRes chatFullScreenErrorDescriptionTextAppearance: Int?) = apply { chatFullScreenErrorDescriptionTextAppearance?.let { this.chatFullScreenErrorDescriptionTextAppearance = it } }
        fun setChatFullScreenErrorBackgroundColor(@ColorInt chatFullScreenErrorBackgroundColor: Int?) = apply { chatFullScreenErrorBackgroundColor?.let { this.chatFullScreenErrorBackgroundColor = it } }
        fun setChatFullScreenErrorIcon(chatFullScreenErrorIcon: Drawable?) = apply { chatFullScreenErrorIcon?.let { this.chatFullScreenErrorIcon = it } }
        fun setChatFullScreenErrorIconTint(@ColorInt chatFullScreenErrorIconTint: Int?) = apply { chatFullScreenErrorIconTint?.let { this.chatFullScreenErrorIconTint = it } }
        fun setChatFullScreenErrorRefreshButtonText(chatFullScreenErrorRefreshButtonText: String?) = apply { chatFullScreenErrorRefreshButtonText?.let { this.chatFullScreenErrorRefreshButtonText = it } }
        fun setChatFullScreenErrorRefreshButtonTextRes(@StringRes chatFullScreenErrorRefreshButtonTextRes: Int?) = apply { chatFullScreenErrorRefreshButtonTextRes?.let { this.chatFullScreenErrorRefreshButtonTextRes = it } }
        fun setChatFullScreenErrorRefreshButtonTextColor(@ColorInt chatFullScreenErrorRefreshButtonTextColor: Int?) = apply { chatFullScreenErrorRefreshButtonTextColor?.let { this.chatFullScreenErrorRefreshButtonTextColor = it } }
        fun setChatFullScreenErrorRefreshButtonVisible(chatFullScreenErrorRefreshButtonVisible: Boolean?) = apply { chatFullScreenErrorRefreshButtonVisible?.let { this.chatFullScreenErrorRefreshButtonVisible = it } }
